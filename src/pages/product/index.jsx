...
const ProductDetail = () => {
    ...
    useEffect(() => {
        const fetchProduct = async () => {
            try {
                const response = await axios.get(`https://botproject.uz/webappbot/api/products/${productId}`);
    ...
    const handleDelete = async () => {
        try {
            await axios.delete(`https://botproject.uz/webappbot/api/products/${productId}`);
    ...
    const handleUpdate = async (e) => {
        ...
        try {
            await axios.put(`https://botproject.uz/webappbot/api/products/update/${productId}`, formData, {
                headers: {
